...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-success">
      <div class="container-fluid text-center">
        <h1 class="text-white text-center font-weight-bold bg-success" style="font-size: 55px;">Login </h1>
        <a href="register.php" class="text-white">Register Now</a>
  ...
  <div class="container"><br>
    ...
    <div class="col-lg-6 m-auto d-block">
      ...
      <form action="login.php" onsubmit="return validation()" class="bg-light" method="post">
        ...
        <input type="submit" name="login" value="submit" class="btn btn-success"   autocomplete="off">
